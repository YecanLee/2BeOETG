...
if __name__ == '__main__':
    ...
    for idx in range(number_of_predictions_per_instance):
        ...
        all_coherence_scores.extend(one_coherence_score)

    coherence_mean, coherence_std = np.mean(all_coherence_scores), np.std(all_coherence_scores)
    result_dict = {
        "coherence_score": [str(score) for score in all_coherence_scores],
    }

    print ('Result save path is {}'.format(evaluation_save_path))
    print (len(result_dict['coherence_score']), "this is the length of the coherence score")
